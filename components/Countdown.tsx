...
export function CountdownSection({ targetDate, onCountdownEnd }: CountdownProps) {
  ...
  const timerComponents = Object.keys(timeLeft).map((interval) => {
    if (timeLeft[interval as keyof CountdownTimeLeft] == null) {
      return null;
    }
    ...
    return (
      ...
      >
        <span className="text-4xl font-light tracking-widest">
          {timeLeft[interval as keyof CountdownTimeLeft]}
        </span>
